import { Component, OnInit, QueryList, Renderer2, ViewChildren, VERSION } from '@angular/core';
...
@Component({
  selector: 'app-basic-tosts',
  templateUrl: './basic-tosts.component.html',
  styleUrls: ['./basic-tosts.component.scss']
})
export class BasicTostsComponent implements OnInit {
