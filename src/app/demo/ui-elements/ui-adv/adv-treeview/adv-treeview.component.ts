...
@Component({
  selector: 'app-adv-treeview',
  templateUrl: './adv-treeview.component.html',
  styleUrls: ['./adv-treeview.component.scss'],
  providers: [ChecklistDatabase]
})
export class AdvTreeviewComponent implements OnInit {
