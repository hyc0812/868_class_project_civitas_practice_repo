...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'range-slider',
        loadChildren: () => import('./adv-range-slider/adv-range-slider.module').then((m) => m.AdvRangeSliderModule)
      },
      {
        path: 'tree-view',
        loadChildren: () => import('./adv-treeview/adv-treeview.module').then((m) => m.AdvTreeviewModule)
      },
      {
        path: 'rating',
