...
export class CrtHighChartComponent implements OnInit {
  ...
  public lineBasicChartOptions: Highcharts.Options = {
  ...
  public barBasicChartOptions: Highcharts.Options = {
  ...
  public areaZoomChartOptions: Highcharts.Options = {
    chart: {
      zoomType: 'x'
    },
    title: {
  ...
  public pieBasicChartOptions: Highcharts.Options = {
    chart: {
  ...
  public pieDonutChartOptions: Highcharts.Options = {
    chart: {
      plotBackgroundColor: null,
      plotBorderWidth: null,
      plotShadow: false,
  ...
  public pie3DChartOptions: Highcharts.Options = {
    chart: {
      type: 'pie',
      options3d: {
        enabled: true,
  ...
  public pieDount3DChartOptions: Highcharts.Options = {
    chart: {
      type: 'pie',
      options3d: {
        enabled: true,
  ...
  public combinationsChartOptions: Highcharts.Options = {
    title: {
        ...
        labels: [
          {
            style: {
              left: '50px',
              top: '18px',
              color: (Highcharts.theme && Highcharts.theme.colors['textColor']) || 'black'
            }
          }
        ]
      }
