...
import { ChangeDetectorRef, Input, Output, EventEmitter, HostListener, forwardRef, Inject, Optional, OnDestroy } from '@angular/core';
...
const UI_SWITCH_CONTROL_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => SwitchConfigComponent),
  multi: true
};
