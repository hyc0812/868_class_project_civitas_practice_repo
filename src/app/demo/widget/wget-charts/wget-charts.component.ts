...
export class WgetChartsComponent implements OnInit, AfterViewInit {
  constructor() {}
  ...
  ngAfterViewInit() {
    setTimeout(() => {
      ...
      const chartSiteVisitDataAm = AmCharts.makeChart('sitevisite-chart', {
        type: 'serial',
        addClassNames: true,
        defs: {
          filter: [
      ...
      const chartCommanDataAm = AmCharts.makeChart('command-card-chart1', {
        type: 'serial',
        addClassNames: true,
        defs: {
          filter: [
      ...
      const chartCallDataAm = AmCharts.makeChart('call-chart', {
        type: 'serial',
        addClassNames: true,
        defs: {
          filter: [
      ...
      const chart = AmCharts.makeChart('Earnings-chart', {
        type: 'serial',
        addClassNames: true,
        defs: {
          filter: [
