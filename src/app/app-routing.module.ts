...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'user',
        loadChildren: () => import('./demo/user/user.module').then((m) => m.UserModule)
      },
      {
        path: 'basic',
      ...
      {
        path: 'imagecropper',
        loadChildren: () => import('./demo/pages/images-cropper/images-cropper.module').then((m) => m.ImagesCropperModule)
      },
      {
        path: 'tables',
      ...
      {
        path: 'icons',
        loadChildren: () => import('./demo/pages/icons/icons.module').then((m) => m.IconsModule)
      },
      // {
      //   path: 'full-calendar',
